    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(related_name='cities_light_region_country', to='cities_light.Country')),
            ],
            options={
                'ordering': ['name'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='city',
            name='country',
            field=models.ForeignKey(related_name='cities_light_city_country', to='cities_light.Country'),
        ),
        migrations.AddField(
            model_name='city',
            name='region',
            field=models.ForeignKey(related_name='cities_light_city_region', blank=True, to='cities_light.Region', null=True),
        ),
